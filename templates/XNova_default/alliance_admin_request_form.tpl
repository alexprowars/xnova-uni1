<br>
	<form action="?set=alliance&mode=admin&edit=requests&show={id}&sort=0" method="POST">
	<tr>
	...
	<tr>
	  <th>&#160;</th>
	  <th><input type="submit" name="action" value="Принять"></th>
	</tr>
	<tr>
	...
	<tr>
	  <th>&#160;</th>
	  <th><input type="submit" name="action" value="Отклонить"></th>
	</tr>
	<tr>
	  <td colspan=2>&#160;</td>
	</tr>
