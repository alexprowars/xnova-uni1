...
$lang['nfo_struct_pt']   = "Структура";
$lang['nfo_shielf_pt']   = "Мощность щита";
$lang['nfo_attack_pt']   = "Оценка атаки";
$lang['nfo_rf_again']    = "Одним залпом поражает";
$lang['nfo_rf_from']     = "одним залпом поражает";
$lang['nfo_capacity']    = "Грузоподъёмность";
$lang['nfo_units']       = "Единиц";
$lang['nfo_base_speed']  = "Начальная скорость";
...
$lang['gate_ship_sel']   = "Колличество кораблей";
...
$lang['info'][6]['name'] = 'Аккумуляторная станция';
$lang['info'][6]['description'] = 'Чтобы улучшить эффективность энергостанций ваши учёные построили сеть аккумуляторных батарей, которые позволяют скапливать излишки энергии. Когда уровень энергии уменьшается ниже критического, то эти батареи могут подпитывать ваше производство.';
$lang['info'][12]['name'] = 'Термоядерная электростанция';
...
$lang['info'][24]['name'] = 'Хранилище дейтерия';
...
$lang['info'][43]['name'] = 'Межгалактические врата';
...
$lang['info'][111]['name'] = 'Броня космических кораблей';
...
$lang['info'][150]['name']    	= "Технология колонизации";
$lang['info'][150]['description'] = "Император, имеющий много колоний во вселеной имеет больше преимуществ перед другими. Каждый уровень развития данной технологии увеличивает максимальное колличество планет вашей империи на +1.";
$lang['info'][160]['name']    	= "Проектирование кораблей";
$lang['info'][160]['description'] = "Правильное проектирование ваших кораблей позволяет расширить их внутреннюю вместимость, и вследствие этого увеличить максимальную вместимость трюмов.";
$lang['info'][161]['name']    	= "Военная база";
$lang['info'][161]['description'] 	= "Обойдя ограничение на колличество планет, вы сможете создавать планеты-карлики, которые удобно использовать в качестве промежуточных баз для флота. Максимальная возможность застройки данной территории - 10 полей. Что на ней размещать это решать вам. С каждым уровнем развития данной технологии увеличивается максимальное колличество таких баз.";
$lang['info'][162]['name']    	= "Экология";
$lang['info'][162]['description'] 	= "Постоянно возрастающая промышленность планет уже не может контролировать выброс отходов. Планета подвергается всё большему влиянию на экологию и это плохо сказывается на населении планеты. Изучение данной технологии позволит сокращать выбросы в окружающую среду на 5% с каждым уровнем, но не более чем на 75%.";
...
$lang['info'][216]['name'] = 'Передвижная база';
$lang['info'][216]['description'] = 'Этот высокотехнологичный корабль, основанный на синтезе тёмной материи способен расширить ваши владения во вселенной, благодаря иследованию ТМ вы можете превратить любую незаселённую территорию в своего рода планету-карлик, где вы сможете создать промежуточную базу для вашего флота. Из недостатков данной технологии можно отнести малое колличесво полей для застройки.';

$lang['info'][217]['name'] = 'Бегемот';
$lang['info'][217]['description'] = 'С развитием цивилизации росли потребности в ресурсах, а соответственно и количество грузоперевозок. Последним словом в этом направлении стали Бегемоты - тяжелые транспорты с увеличенным трюмом. Объем перевозимых Бегемотом ресурсов превышает объем Большого Транспорта в десять раз. Высокая стоимость окупается толстой броней и приличной скоростью.';
// ----------------------------------------------------------------------------------------------------------
...
$lang['info'][407]['name'] = 'Малый щитовой купол';
...
$lang['info'][408]['name'] = 'Большой щитовой купол';
